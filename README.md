# Robotic rover challenge

This is a simple python 2 (it can probably work on python 3 -- I haven't tested it yet) implementation to the robotic rover challenge problem.
